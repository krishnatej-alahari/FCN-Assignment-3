...
class Router(Node):
    ...
    def in_router_dir(self):
        ...
        self.cmd('cd %s' % self.name) # Changing directories like r1, r2, and so on..
        # self.cmd('mkdir test')
        yield
        self.cmd('cd %s' % working_dir) # Getting back to the original directory
